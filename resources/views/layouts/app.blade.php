    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-teal p-6">
        ...
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset('image/superenvios.png') }}" alt="Super Envios Today" class="img-fluid"
                 width="60">
            <span
                class="font-semibold text-xl tracking-tight ml-3">{{ config('app.name', 'Super Envios Today Develop') }}</span>
        </a>
                    ...
                    @if(Auth::user()->hasRole('coordinator'))
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="coordinator-dropdown">
                                ...
                                <a class="dropdown-item" href="{{route('registerOperatorAccount')}}">Agregar Cuenta</a>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('transactions_fix')}}">Transaccion de Ajuste</a>
                                <div class="dropdown-divider"></div>
