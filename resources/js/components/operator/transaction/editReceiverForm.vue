<template>
    <validation-observer tag="div" class="modal-card" style="width: auto">
        ...
        <footer class="modal-card-foot">
            <b-button :loading="savingData" class="button is-primary" @click="editReceiver">Guardar</b-button>
    ...
    export default {
        ...
        methods: {
            ...
            async editReceiver() {
                ...
                try {
                    const response = await $http.patch(`/api/user/${this.receiver.id}`, {
                        idn: this.idn,
