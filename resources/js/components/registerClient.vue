<template>
   <div class="container mx-auto">
    <div class="w-full max-w-md mx-auto">
      <form method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" >
        ...
        <v-select name="idn_type" class="mb-3" :class="{'border-red':hasInErrors('idn')}" :searchable="false" :clearable="false" :options='idnTypes' v-model="person.idn_type" @blur="cleanError('idn_type')"></v-select>
        ...
        <input id="name" type="text" class="input-base" @blur="cleanError('name')" :class="{'border-red':hasInErrors('name')}" name="name" v-model="person.name" required autofocus>
        ...
        <input id="last_name" type="text"  @blur="cleanError('last_name')":class="{'border-red':hasInErrors('last_name')}" class="input-base" name="last_name" v-model="person.last_name" required autofocus>
        ...
        <input id="phone" type="text" @blur="cleanError('phone')" :class="{'border-red':hasInErrors('phone')}" class="input-base" name="phone" v-model="person.phone" required autofocus>
        ...
        <input class="input-base" :class="{'border-red':hasInErrors('last_name')}" type="email" id="email"  name="email"v-model="person.email" required autofocus>
        ...
        <input class="input-base" :class="{'border-red':hasInErrors('email_confirmation')}" type="email" id="email_confirmation"  name="email"v-model="person.email_confirmation" required autofocus>
 ...
 <label for="address" class="label-base">Dirección</label>
        ...
        <textarea id="address" class="input-base" :class="{'border-red':hasInErrors('address')}" v-model="person.address" required autofocus name="address" >
        </textarea>
        ...
        <input id="password" type="password" :class="{'border-red':hasInErrors('password')}" class="input-base" name="password" v-model="person.password" required>
<span v-if="hasInErrors('password')" class="error-base" role="alert">
        ...
        <input id="password_confirmation" v-model="person.password_confirmation" type="password" :class="{'border-red':hasInErrors('password_confirmation')}" class="input-base" name="password_confirmation" required>
