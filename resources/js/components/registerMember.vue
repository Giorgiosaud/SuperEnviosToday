<template>
    <div class="container mx-auto">
        <div class="w-full max-w-md mx-auto">
            ...
            <v-select name="idn_type" class="mb-3 bg-white" :class="{'border-red':hasInErrors('idn')}" :searchable="false"
          ...
          <strong>{{ getError('idn_type') }}</strong>
            ...
            <v-select v-model="person.roles" id="roles" class="bg-white" label="name" index="name_id" multiple :options="roles"></v-select>
