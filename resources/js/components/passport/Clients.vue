        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div
              ...
              <ul>
                <li
                  v-for="(error,errorID) in createForm.errors"
                  :key="errorID">
                  {{ error }}
                </li>
              </ul>
            ...
            <form role="form">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <label for="create-client-name">create-client-name</label>
                  <input
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div
              ...
              <ul>
                <li
                  v-for="(error, errorId2) in editForm.errors"
                  :key="errorId2">
                  {{ error }}
                </li>
              </ul>
            ...
            <form role="form">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <label for="redirect-2">redirect-2</label>
                  <input
                    id="redirect-2"
