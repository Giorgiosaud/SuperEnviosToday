  ...
  <section>
    ...
    <b-table
      ...
      <b-table-column field="client"
                      ...
                      v-slot="props"
      >
        <a :title="$t('pendingTransactions.Client:EXTRA_DATA')"
      ...
      <b-table-column field="operator_account"
                      ...
                      v-slot="props"
      >
        <a :title="$t('pendingTransactions.FOREIGN_OPERATOR:EXTRA_DATA')"
      ...
      <b-table-column field="venezuelan_operator"
                      ...
                      v-slot="props"
      >
        <a :title="$t('pendingTransactions.VENEZUELAN:EXTRA_DATA')"
      ...
      >
        <div
          ...
          <p class="control">
            ...
            >
              {{$t('pendingTransactions.STATUS:APPROVE')}}
            </button>
          </p>
          <p class="control">
            <button
            ...
            >
              {{$t('pendingTransactions.STATUS:REJECT')}}
            </button>
          </p>
        </div>
  ...
  methods: {
    ...
    async approveTransaction(transaction) {
      ...
      try {
        ...
        this.$buefy.notification.open({
          message: `Rechazo fallido message: ${error.response.data.message}`,
          type: 'is-warning',
          position: 'is-bottom-right',
          duration: 5000,
        });
