...
Route::group(['middleware' => ['auth:api', 'role:coordinator']], function () {
    ...
    Route::post('add-account', 'AccountController@addAccounts');
    Route::post('operator-asociate-account', 'AccountController@asociateForeignAccounts');
...
//TODO agregar client_user_id en tabla de transacciones
//TODO agregar receiver_user_id y venezuelan_user_id en tabla de transacciones pendientes
