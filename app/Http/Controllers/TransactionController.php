<?php
  ...
  class TransactionController extends Controller {
    ...
    public function venezuelanTransactionsAPI(Request $request) {
      ...
      $transactions = Transaction::with(['destinationAccount.owner', 'parentTransaction.destinationAccount.owner', 'originAccount'])->whereIn('from_account_id', $accountsId)->paginate($limit);
    ...
    public function venezuelanTransactionsCountAPI(Request $request) {
      ...
      return Transaction::with(['destinationAccount.owner', 'parentTransaction.destinationAccount.owner', 'originAccount'])->whereIn('from_account_id', $accountsId)->where('status', '!=', 'executed')->count();
